...
type ConsoleThrottles struct {
	...
	Lines uint64 `json:"lines" mapstructure:"lines" default:"2000"`
	...
	MaximumTriggerCount uint64 `json:"maximum_trigger_count" mapstructure:"maximum_trigger_count" default:"5"`
	...
	LineResetInterval uint64 `json:"line_reset_interval" mapstructure:"line_reset_interval" default:"100"`
	...
	DecayInterval uint64 `json:"decay_interval" mapstructure:"decay_interval" default:"10000"`
	...
	StopGracePeriod uint `json:"stop_grace_period" mapstructure:"stop_grace_period" default:"15"`
}
